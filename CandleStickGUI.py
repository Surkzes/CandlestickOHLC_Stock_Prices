...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("CandleStick OHLC", "CandleStick OHLC"))
        self.pushButton.setText(_translate("CandleStick OHLC", "Get Candlestick"))


    # Functions to collect simulation data and load the picture
    def run_simulation(self):
        get_candlestick_data(self.ticker_value, self.start_date, self.end_date)
